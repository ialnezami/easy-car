      ...
      <div className="card p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center gap-6 pb-6 border-b border-slate-200">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-error-500 to-error-400 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
          ...
          <div className="pt-6 border-t border-slate-200">
            ...
            <div className="bg-slate-50 rounded-xl p-4 space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-error-600">Administrator</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-600">Permissions:</span>
                <span className="font-semibold text-slate-900">Full System Access</span>
              </div>
            </div>
          </div>
